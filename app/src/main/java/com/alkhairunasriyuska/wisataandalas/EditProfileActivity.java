...
public class EditProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.addValueEventListener(new ValueEventListener() { // Lama => addListenerForSingleValueEvent
            @Override
                ...
                if (photo_location != null){
                    ...
                    storageReference1.putFile(photo_location).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            // melakukan upload.  url dan Gambar
                            String uri_photo = taskSnapshot.getUploadSessionUri().toString(); //beda
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        // membuat validasi apakah foto/hasil sudah ada atau belum
